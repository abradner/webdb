Feature: Request an account
  ...
  Background:
    ...
    And I have a user "diego.alonso@intersect.org.au" with role "manager"
  ...
  Scenario: Email to superuser upon account request and clicking through to access requests page
    ...
    When I fill in the following:
      ...
      | Last Name        | Bloggs                    |
    And I press "Submit Request"
    Then "diego.alonso@intersect.org.au" should receive an email with subject "WebDB - There has been a new access request"
