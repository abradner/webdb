Feature: Request an account
  ...
  Background:
    ...
    And I have a user "some.super.user@intersect.org.au" with role "manager"

  Scenario: Request account
    Given I am on the request account page
    When I fill in the following:
      | Email            | super.user@intersect.org.au |
      | Password         | paS$w0rd                    |
  ...
  Scenario: Email to superuser upon account request and clicking through to access requests page
    ...
    When I fill in the following:
      ...
      | Last Name        | Bloggs                      |
    And I press "Submit Request"
    Then "some.super.user@intersect.org.au" should receive an email with subject "WebDB - There has been a new access request"
    When they open the email
    Then they should see "An access request has been made with the following details:" in the email body
    And they should see "Email: super.user@intersect.org.au" in the email body
    ...
    And I fill in "Email" with "some.super.user@intersect.org.au"
    ...
    And I should see "access_requests" table with
      ...
      | Fred       | Bloggs    | super.user@intersect.org.au |
...
#devise methods are breaking
  ...
  Scenario: Deactivated supers shouldn't get the email
    Given I have a user "fred@intersect.org.au" with role "manager"
