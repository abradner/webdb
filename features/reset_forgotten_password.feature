Feature: Reset forgotten password
  ...
  Scenario: Reset forgotten password
    Given I have a user "super.user@intersect.org.au"
    And I am on the home page
    When I follow "Forgot your password?"
    And I fill in "Email" with "super.user@intersect.org.au"
    ...
    And "super.user@intersect.org.au" should receive an email
    When I open the email
    Then I should see "Someone has requested a link to change your password on the WebDB site, and you can do this through the link below." in the email body
    ...
    And I should be able to log in with "super.user@intersect.org.au" and "Pass.456"
  ...
  Scenario: Deactivated user gets an email saying they can't reset their password
    ...
    When I open the email
    Then I should see "Someone has requested a link to change your password on the WebDB site. However your account is not active so you cannot reset your password." in the email body
  ...
  Scenario: Error displayed if email left blank
   ...
   Scenario: New password and confirmation must match
     Given I have a user "super.user@intersect.org.au"
     When I request a reset for "super.user@intersect.org.au"
     And "super.user@intersect.org.au" should receive an email
