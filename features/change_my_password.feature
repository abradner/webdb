Feature: Change my password
  ...
  Scenario: Change password
    ...
    And I should be able to log in with "super.user@intersect.org.au" and "Pass.123"
  ...
  Scenario: Change password not allowed if current password is empty
    ...
    And I should be able to log in with "super.user@intersect.org.au" and "Pas$w0rd"
